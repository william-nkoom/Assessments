...
# produce a histogram of age 20 years and above, grouped by gender - First Figure
...
nhanes_20
  ...
  # bar graph of ethnicity_2 grouped by gender - Figure 2
...
##### Differences between the outputs from the two packages
...
```{r Exercise 2, echo = FALSE, message = FALSE}
